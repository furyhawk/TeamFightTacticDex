...
import com.furyhawk.teamfighttacticdex.model.*
import com.furyhawk.teamfighttacticdex.model.Paragraph
import com.furyhawk.teamfighttacticdex.ui.ThemedPreview

private val defaultSpacerSize = 16.dp

@Composable
fun PostContent(post: Hero, modifier: Modifier = Modifier) {
    VerticalScroller {
...
@Composable
private fun PostHeaderImage(post: Hero) {
