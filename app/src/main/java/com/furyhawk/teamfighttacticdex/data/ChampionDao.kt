...
interface ChampionDao {
    ...
    fun getPlants(): LiveData<List<Champion>>

    @Query("SELECT * FROM champions ORDER BY name")
    fun getPlantsWithGrowZoneNumber(growZoneNumber: Int): LiveData<List<Champion>>

    @Query("SELECT * FROM champions WHERE id = :plantId")
    fun getPlant(plantId: String): LiveData<Champion>
